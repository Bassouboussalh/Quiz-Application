...
import com.boussalh.quizapp.Adapter.QuestionAdapter
import com.boussalh.quizapp.Domain.QuestionModel
import com.boussalh.quizapp.R
import com.boussalh.quizapp.databinding.ActivityQuestionBinding
...
class QuestionActivity : AppCompatActivity(), QuestionAdapter.score {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            leftArrow.setOnClickListener {
                ...
                position--
                progressBar.progress = progressBar.progress - 1
                questionNumber.text = "Question" + progressBar.progress + progressBar + "/10"
                questionTxt.text = receivedList[position].question
    ...
    override fun amount(number: Int, clickAnswer: String) {
        allScore += number
        receivedList[position].clickedAnswer = clickAnswer
    }
}